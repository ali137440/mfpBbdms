...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <body  style="background-color: #75daad">
   ...
   <h2 class="text-center">ADMIN MEMBERS LIST</h2><br><br>
<div class="container">
	<div class="row">
		<div class="col-md-12">
        ...
        <td><?php echo $data['phone'];?></td>
         <td><?php echo $data['gender'];?></td>
          <td><?php echo $data['password'];?></td>
           <td ><img src="adminimage/<?php echo $data['image'];?>" style="max-width: 70px;"></td>
            <input type="hidden" name="id" value="<?php echo $data['id'];?>">
            <td> <a href="Delete.php?id=<?php echo $data['id'];?>" ><button type="button" class="btn btn-danger" style="font-size: 25px"><i class="fa fa-trash"></i></button></td>
    </tr>
    </tbody><?php
