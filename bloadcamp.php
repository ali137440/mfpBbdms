...
<html lang="en">
  ...
  <body  style="background-color: #75daad">
   ...
   <h2 class="text-center">ADD CAPM DETAILS HERE</h2><br><br>
...
<form method="post" action="camppost.php"  id="qual" class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label for="exampleFormControlInput1">Venue<span style="color :red;">*</span></label>
    <input type="text" name="venue" class="form-control" id="exampleFormControlInput1" placeholder="Address your CAPM">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Organized-By<span style="color :red;">*</span></label>
    <input type="text" name="organizer" class="form-control" id="exampleFormControlInput1" placeholder="Name of the Organizer"required="required">
  </div>
  <div class="form-group">
    <label for="exampleFormControlInput1">Date<span style="color :red;">*</span></label>
    <input type="date" name="date" class="form-control" id="exampleFormControlInput1"required="required">
  </div>
