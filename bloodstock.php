...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <a  class="nav-link active"  href="bloodstock.php"  style="text-decoration: none;color: whilte"><i class="fa fa-tint" style="padding-right: 8px"></i>BLOOD STOCK</a>
...
<table class="table table-hover">
  <thead>
    ...
    <tr>
      <td>1</td>
      <td>A+</td>
       <td><?php include('dbcon.php');
       $query="SELECT * FROM `doner` WHERE `bloodgroup`='A+'";
    ...
    <tr>
      ...
      <td>B+</td>
       <td><?php include('dbcon.php');
       $query="SELECT * FROM `doner` WHERE `bloodgroup`='B+'";
       $run=mysqli_query($con,$query);
       $row=mysqli_num_rows($run);
       echo $row;
       ?></td>
    ...
    <tr>
      ...
      <td>O+</td>
       <td><?php include('dbcon.php');
       $query="SELECT * FROM `doner` WHERE `bloodgroup`='O+'";
       $run=mysqli_query($con,$query);
       $row=mysqli_num_rows($run);
       echo $row;
       ?></td>
    ...
    <tr>
      ...
      <td>AB+</td>
       <td><?php include('dbcon.php');
       $query="SELECT * FROM `doner` WHERE `bloodgroup`='AB+'";
       $run=mysqli_query($con,$query);
       $row=mysqli_num_rows($run);
       echo $row;
       ?></td>
...
<div class="col-md-6">
  <img src="images/pos2.jpg" style="height: 600px;width: 400px">
  </div>
</div>
</div>
