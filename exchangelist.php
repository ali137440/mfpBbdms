  ...
  <thead>
    <tr>
      ...
      <th scope="col">Email</th>
       ...
       <th scope="col">Given BloodGroup</th>
        <th scope="col">Needed BloodGroup</th>
...
if($run==true){
  ...
  while($data=mysqli_fetch_assoc($run)){
    ...
    <tr>
      ...
      <td><?php echo $data['give_blood'];?></td>
            <td><?php echo $data['need_blood'];?></td>
